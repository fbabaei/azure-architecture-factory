...
4. [docs/BRD_CLASSIFICATION_FLOW.md](docs/BRD_CLASSIFICATION_FLOW.md) — how the factory decides whether a BRD needs the Agent Framework SDK runtime.
5. [docs/AGENT_FRAMEWORK_RUNTIME_PATTERN.md](docs/AGENT_FRAMEWORK_RUNTIME_PATTERN.md) — when a generated project should ship the Agent Framework SDK runtime vs. stay deterministic.
6. [docs/SELF_CONTAINED_SETUP.md](docs/SELF_CONTAINED_SETUP.md) — running the repo without any sibling checkouts.
