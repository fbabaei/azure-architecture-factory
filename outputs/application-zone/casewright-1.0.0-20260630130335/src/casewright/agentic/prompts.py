"""Prompt templates for the agentic RAG engine (ported from case-assistant-agent)."""
from __future__ import annotations


class QueryRewriterPrompts:
    """Prompt templates for HyDE query rewriting."""
...
"""
    ...
    def build_answer_prompt(query: str, vetted_results_formatted: str) -> str:
        """Build the answer-generation prompt with the user query and vetted results."""
...
- Use the EXACT Content ID shown in the result (e.g., "Content ID: abc123_text_sections_0" → cite as {{abc123_text_sections_0}}).
...
Example: "Azure Cosmos DB supports multiple APIs.{{abc123_text_sections_0}} It provides global distribution.{{abc123_text_sections_1}}"
...
class ReflectionAgentPrompts:
    """Prompt templates for the reflection/review agent."""
