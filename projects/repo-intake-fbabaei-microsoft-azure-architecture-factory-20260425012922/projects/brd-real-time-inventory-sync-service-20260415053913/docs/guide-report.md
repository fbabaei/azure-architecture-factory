# 🧭 Guide Report — BRD: Real-Time Inventory Sync Service

_Generated at **2026-04-16T02:59:40.830034Z** by the factory guide report generator (deterministic, no LLM). Regenerate any time by re-running `scripts/generate_guide_report.py` or by clicking **🧭 Guide Me → Refresh**._

## Snapshot

- **Project slug:** `brd-real-time-inventory-sync-service-20260415053913`
...
`C:\Users\fbabaei\app\brd-real-time-inventory-sync-service-20260415053913` was created by the starter runner. It will drift from the workspace copy after regeneration. Treat the workspace project as the source of truth.

Related: `C:\Users\fbabaei\app\brd-real-time-inventory-sync-service-20260415053913`
...
1. **Run agent `azure-architecture-implementer`** — Regenerate infra + services so they match the BRD and diagram.
   - Arguments: `project-path: projects/brd-real-time-inventory-sync-service-20260415053913`, `networkTier: private`, `enableObservability: True`
2. **Run agent `bicep-infrastructure-validator`** — Catch Bicep syntax/logic errors before deploy.
   - Arguments: `project-path: projects/brd-real-time-inventory-sync-service-20260415053913`
