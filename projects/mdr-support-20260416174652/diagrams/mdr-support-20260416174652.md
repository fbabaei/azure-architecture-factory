...
- workflow: yes
- api: no
- observability_wiring: no
- network_tier: public

## Detailed Architecture

- [Detailed Architecture Document](../docs/detailed-architecture.md)
- [Detailed Architecture Diagram Notes](mdr-support-20260416174652-detailed-architecture.md)
- [Detailed Architecture Draw.io](mdr-support-20260416174652-detailed-architecture.drawio)
