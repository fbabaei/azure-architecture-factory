...
& $PythonExecutable -c "import agent_framework, agent_framework.foundry; print('agent_framework OK:', agent_framework.__version__ if hasattr(agent_framework, '__version__') else 'rc6')"
