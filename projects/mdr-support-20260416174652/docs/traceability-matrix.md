...
| REQ-002 | File upload–based extraction | Architecture overview — `docs/architecture-overview.md`; Starter API — `src/copilot_api/main.py` | Scaffolded | Assign acceptance owner; verify generated artifact covers intent |
| REQ-003 | An interactive, human‑in‑the‑loop chat experience that guides users through creating an arrangement. | Architecture overview — `docs/architecture-overview.md`; Starter API — `src/copilot_api/main.py` | Scaffolded | Assign acceptance owner; verify generated artifact covers intent |
