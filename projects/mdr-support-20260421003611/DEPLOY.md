...
4. Build & push the container image: `docker build -t <registry>/mdr-support-20260421003611:latest src/ && docker push <registry>/mdr-support-20260421003611:latest`.
5. Deploy the project from `projects/mdr-support-20260421003611`.
