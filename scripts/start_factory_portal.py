...
RECONFIGURABLE_AGENT_OPTIONS = {
    ...
    "conversational-assistant-reconfigurable-agent": {
        "name": "Conversational Assistant Reconfigurable Agent",
        "summary": "Configure a reusable multi-turn conversational assistant over Azure OpenAI: persona/system prompt, model, conversation memory, context-window management, tool/grounding hooks, streaming, session state, safety/fallback, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "CHANNELS",
    ...
    "translation-localization-reconfigurable-agent": {
        "name": "Translation & Localization Reconfigurable Agent",
        "summary": "Configure reusable translation and localization: language coverage, detection, translation service, glossaries/terminology, content types, localization, quality/review, privacy, and validation.",
        "contract": [
            "AI_WORKFLOW",
    ...
    "vision-analysis-reconfigurable-agent": {
        "name": "Vision Analysis Reconfigurable Agent",
        "summary": "Configure reusable image analysis: image sources, analysis tasks, vision service/model, OCR, output schema, confidence thresholds, human review, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "IMAGE_SOURCES",
            "ANALYSIS_TASKS",
    ...
    "embedding-vectorization-reconfigurable-agent": {
        "name": "Embedding & Vectorization Reconfigurable Agent",
        "summary": "Configure reusable embedding and vectorization: content inventory, embedding model, dimensions, chunk-to-vector strategy, vector index config, re-embedding, cost/latency, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "CONTENT_INVENTORY",
            "EMBEDDING_MODEL",
    ...
    "model-routing-gateway-reconfigurable-agent": {
        "name": "Model Routing & AI Gateway Reconfigurable Agent",
        "summary": "Configure reusable model routing and an AI gateway: model inventory, routing, load balancing, token limits, fallback, semantic caching, observability/metrics, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "MODEL_INVENTORY",
            "ROUTING_POLICY",
    ...
    "fine-tuning-model-customization-reconfigurable-agent": {
        "name": "Fine-Tuning & Model Customization Reconfigurable Agent",
        "summary": "Configure reusable model fine-tuning and customization: base model, method (SFT/DPO/RFT/distillation), training data, graders, hyperparameters, evaluation/acceptance, deployment, cost/quota, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "BASE_MODEL",
    ...
    "image-generation-reconfigurable-agent": {
        "name": "Image Generation Reconfigurable Agent",
        "summary": "Configure reusable text-to-image generation: image model, prompt templates, size/quality, moderation, output/storage, rate/cost, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "IMAGE_MODEL",
            "PROMPT_TEMPLATES",
    ...
    "video-generation-reconfigurable-agent": {
        "name": "Video Generation Reconfigurable Agent",
        "summary": "Configure reusable video generation: video model, generation mode, prompt/input assets, duration/resolution, async job handling, moderation, output/storage, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "VIDEO_MODEL",
            "GENERATION_MODE",
    ...
    "knowledge-graph-graphrag-reconfigurable-agent": {
        "name": "Knowledge Graph & GraphRAG Reconfigurable Agent",
        "summary": "Configure reusable knowledge-graph construction and graph-augmented retrieval: source corpus, entity/relationship schema, extraction, graph store, indexing, GraphRAG retrieval, grounding/citations, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "SOURCE_CORPUS",
    ...
    "batch-bulk-inference-reconfigurable-agent": {
        "name": "Batch & Bulk Inference Reconfigurable Agent",
        "summary": "Configure reusable large-scale offline/batch inference: workload profile, batch job design, input/output format, checkpoint/resume, throughput/quota, error/retry, cost, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "WORKLOAD_PROFILE",
            "BATCH_JOB_DESIGN",
    ...
    "agent-memory-state-reconfigurable-agent": {
        "name": "Agent Memory & State Reconfigurable Agent",
        "summary": "Configure reusable agent memory and state: memory scopes, short-term and long-term memory, summarization, retrieval, retention/privacy, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "MEMORY_SCOPES",
            "SHORT_TERM_MEMORY",
    ...
    "content-generation-summarization-reconfigurable-agent": {
        "name": "Content Generation & Summarization Reconfigurable Agent",
        "summary": "Configure reusable content generation and summarization: input content, generation tasks, model, prompts/templates, output schema, style/tone, grounding/factuality, safety, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "INPUT_CONTENT",
            "GENERATION_TASKS",
    ...
    "multi-agent-orchestration-reconfigurable-agent": {
        "name": "Multi-Agent Orchestration Reconfigurable Agent",
        "summary": "Configure reusable multi-agent orchestration: agent inventory, orchestration pattern, handoff contracts, planning, shared state/memory, error/fallback, observability, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "AGENT_INVENTORY",
    ...
    "data-privacy-pii-redaction-reconfigurable-agent": {
        "name": "Data Privacy & PII Redaction Reconfigurable Agent",
        "summary": "Configure reusable data privacy and PII redaction: data inventory, PII categories, detection, redaction/de-identification, data residency, retention/minimization, audit, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "DATA_INVENTORY",
            "PII_CATEGORIES",
    ...
    "deployment-release-reconfigurable-agent": {
        "name": "Deployment & Release Reconfigurable Agent",
        "summary": "Configure reusable deployment and release: deployment targets, release strategy, environment promotion, versioning, rollback, quota/capacity, release gates, observability hooks, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "DEPLOYMENT_TARGETS",
            "RELEASE_STRATEGY",
    ...
    "feedback-continuous-learning-reconfigurable-agent": {
        "name": "Feedback & Continuous Learning Reconfigurable Agent",
        "summary": "Configure reusable feedback capture and continuous-learning loops: feedback sources, schema, labeling/preference data, dataset curation, learning-loop target, guardrails/review, privacy, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "FEEDBACK_SOURCES",
            "FEEDBACK_SCHEMA",
    ...
    "recommendation-personalization-reconfigurable-agent": {
        "name": "Recommendation & Personalization Reconfigurable Agent",
        "summary": "Configure reusable recommendation and personalization: user/item data, personalization signals, method, ranking, cold-start, privacy/consent, evaluation metrics, security, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "USER_AND_ITEM_DATA",
    ...
    "serverless-event-driven-hosting-reconfigurable-agent": {
        "name": "Serverless & Event-Driven Hosting Reconfigurable Agent",
        "summary": "Configure the compute/runtime substrate that runs an AI workload: Azure Functions, Container Apps, Container Apps Jobs, Durable Functions, triggers/bindings, scale-to-zero, concurrency, cold-start, state/durability, idempotency/retry, security, cost, and validation.",
        "contract": [
            "AI_WORKFLOW",
            "WORKLOAD_SHAPE",
            "HOSTING_TARGET",
...
def _build_agent_foundry_export_package(run: dict) -> tuple[str, bytes]:
    """Build a portable zip package for using a completed agent outside the portal."""
    agent_payload = run.get("agentFoundry") if isinstance(run.get("agentFoundry"), dict) else {}
    ...
    selected_agent = plan.get("selectedAgent") or agent_payload.get("selectedAgent") or "azure-ai-search-reconfigurable-orchestrator"
    selected_agent_info = RECONFIGURABLE_AGENT_OPTIONS.get(selected_agent, RECONFIGURABLE_AGENT_OPTIONS["azure-ai-search-reconfigurable-orchestrator"])
    title = str(plan.get("title") or agent_payload.get("title") or "agent-foundry-export")
    package_slug = _sanitize_project_slug(re.sub(r"[^a-z0-9-]+", "-", title.lower()).strip("-")) or "agent-foundry-export"
    ...
    config = {
        ...
        "agent": {
            ...
            "name": selected_agent_info.get("name"),
            "summary": selected_agent_info.get("summary"),
            "definitionPath": f".github/agents/{selected_agent}.agent.md",
        },
        "recommendation": plan.get("agentRecommendation") or {},
    ...
    report_json = json.dumps(
        {
            "run": _safe_agent_foundry_run(run),
            "plan": plan,
            "execution": execution,
            "evidence": agent_payload.get("evidence") or [],
        },
    ...
    original_agent_path = FACTORY_REPO_ROOT / "agent-foundry" / ".github" / "agents" / f"{selected_agent}.agent.md"
    original_agent = ""
    if original_agent_path.is_file():
        original_agent = original_agent_path.read_text(encoding="utf-8")

    configured_agent = f"""---
name: {title} - {selected_agent_info.get('name')}
description: Configured export of {selected_agent_info.get('name')} generated by Azure Architecture Factory.
---

# {title}

This agent package was exported from the Azure Architecture Factory portal on {generated_at}.

## Use

1. Copy `.github/agents/{selected_agent}.agent.md` into a repository or VS Code agent customization location.
2. Keep `agent.config.json` with the project or paste its configuration profile into the agent chat.
3. Start a chat with the agent and use `starter.prompt.md` as the first prompt.
4. Confirm fields marked `needs_confirmation` before implementation or deployment work.
...
"""
    starter_prompt = f"""---
mode: agent
description: Start using the exported {selected_agent_info.get('name')} package.
---

Use the exported `{selected_agent_info.get('name')}` configuration in `agent.config.json`.

First, summarize the configured retrieval pattern, data sources, security model, grounding policy, and validation checklist. Then ask only for missing fields marked `needs_confirmation`. Do not claim hosted execution unless a hosted runtime adapter is configured.
"""
    readme = f"""# {title}

This zip contains a reusable Agent Foundry export created from portal run `{run.get('id')}`.

## Contents

- `.github/agents/{selected_agent}.agent.md`: the original embedded reconfigurable agent definition.
- `configured-agent.agent.md`: a configured wrapper with the portal output and original definition.
- `agent.config.json`: portable configuration values, selected agent metadata, guardrails, and validation checklist.
- `starter.prompt.md`: a first prompt for using the agent outside the portal.
- `execution-report.json`: the full plan, evidence, and execution report from the portal run.

## Use Outside The Portal

Copy the `.github/agents` file into a repository that uses Copilot custom agents, or place it in your VS Code user agent customization area. Keep `agent.config.json` with your project and use `starter.prompt.md` to start a new chat.

The package is not a hosted service by itself. To turn it into a hosted runtime, publish the same configuration through a Microsoft Foundry or application-runtime adapter.
"""
    ...
    with zipfile.ZipFile(buffer, "w", compression=zipfile.ZIP_DEFLATED) as archive:
        ...
        archive.writestr("configured-agent.agent.md", configured_agent)
        archive.writestr("starter.prompt.md", starter_prompt)
        archive.writestr("execution-report.json", report_json)
        if original_agent:
...
class FactoryPortalHandler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if request_path.startswith("/api/agent-foundry/runs/") and request_path.endswith("/export"):
            if not self._require_auth_for_mutation():
                return
    ...
    def _handle_agent_foundry_run_export(self, run_id: str):
        with RUNS_LOCK:
            run = RUNS.get(run_id)
            if not run or run.get("kind") != "agent-foundry":
                self._send_json({"error": "Agent Foundry run not found"}, 404)
            ...
            if run.get("status") != "completed":
                self._send_json({"error": f"Run must be completed before export. Current status: {run.get('status')}"}, 409)
                return
            try:
                file_name, body = _build_agent_foundry_export_package(run)
            except Exception as exc:
